...
function Home() {
  ...
  return (
   <>
   <Head>
    <title>L'univers de Jean-Hugues Pam, Développeur full stack junior React JS | React Native | Node JS | Spécialiste communication digitale et passionné de code</title>
    ...
    <main className={styles.main} lang="fr">
      ...
      <Content className={styles.content} title='La maîtrise de la Force' text='Création, développement & coordination de projets digitaux : applications web & mobiles, e-magazines, e-mailing responsives. JavaScript, TypeScript,'
        text2='Node.JS, HTML, CSS, React JS, React Native, Express, Redux, MongoDB, Git, Git Hub, VS Code, Vercel, Expo Go, Jira'
